# Contributing to oxidized-commands
...
```bash
# 1. Fork and clone
git clone https://github.com/oxidized-mc/commands.git
cd commands
...
`oxidized-commands` is a library crate in the
...
Use `commands` as the scope for all changes to this crate.
