...
- Parsing vulnerabilities (malformed command input causing panics or crashes)
- Memory safety issues (should be none — the crate enforces `#![deny(unsafe_code)]`)
- Denial of service via pathological input (deeply nested commands, unbounded allocations)
